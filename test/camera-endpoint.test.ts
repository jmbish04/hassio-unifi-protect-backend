...
describe('Camera Endpoint Tests', () => {
  ...
  describe('getCameraSnapshot() - Service Layer', () => {
    ...
    it('should throw error when PROTECT_API is not configured', async () => {
      ...
      await expect(serviceWithoutApi.getCameraSnapshot('cam_driveway')).rejects.toThrow('PROTECT_API environment variable is not configured');
    });
  });
  ...
  describe('Performance and Logging', () => {
    it('should log API calls and responses', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'Fetching cameras from: https://test-protect.example.com/protect/cameras'
      );
